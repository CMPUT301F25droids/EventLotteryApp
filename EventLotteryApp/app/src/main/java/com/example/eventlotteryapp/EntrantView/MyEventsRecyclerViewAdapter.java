...
import com.example.eventlotteryapp.EntrantView.placeholder.PlaceholderContent.PlaceholderItem;
...
public class MyEventsRecyclerViewAdapter extends RecyclerView.Adapter<MyEventsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyEventsRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(FragmentMyEventsBinding binding) {
